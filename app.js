...
fetch("https://mis.twse.com.tw/stock/api/getStockInfo.jsp?ex_ch=tse_2330.tw&json=1&delay=0").then(r=>r.text()).then(x=>alert("MIS2330:"+x.slice(0,100))).catch(e=>console.log("MIS_ERR",e));
